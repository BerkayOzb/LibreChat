        ...
        <>
          <TooltipAnchor
            ...
            render={
              ...
              >
                {tags.length > 0 ? (
                  <BookmarkFilledIcon width={20} height={20} className="text-text-primary" aria-hidden="true" />
                ) : (
                  <BookmarkIcon width={20} height={20} className="text-text-primary" aria-hidden="true" />
                )}
              </MenuButton>
            }
          />

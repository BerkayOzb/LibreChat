    ...
    <FormProvider {...methods}>
      ...
      >
        <div className="flex w-full flex-wrap">
          ...
          {assistant_id && (
            <button
              className="btn btn-primary focus:shadow-outline mx-2 mt-1 h-[40px] rounded bg-gray-700 px-4 py-2 font-semibold text-white hover:bg-gray-600 focus:border-gray-500 focus:outline-none focus:ring-0 dark:bg-gray-600 dark:hover:bg-gray-500"
              type="button"
        ...
        <div className="bg-surface-50 h-auto px-4 pb-8 pt-3 dark:bg-transparent">
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            {/* Submit Button */}
            <button
              className="btn btn-primary focus:shadow-outline flex w-full items-center justify-center px-4 py-2 font-semibold text-white hover:bg-gray-600 focus:border-gray-500 dark:hover:bg-gray-500"
              type="submit"
            >
              {submitContext}
            </button>

...
export const checkBannedStatus = () => `${BASE_URL}/api/user/check-banned`;
...
/* Tool Settings */
export const toolVisibility = () => `${BASE_URL}/api/tools/visibility`;
export const enabledTools = () => `${BASE_URL}/api/tools/enabled`;
